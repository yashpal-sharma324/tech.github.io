...
<nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img src="misc/101.jpg" alt="Los Angeles">
	  <div>
	  
	  
    </div>
    <div class="carousel-item">
      <img src="misc/502.jpg" alt="Chicago">
    </div>
    <div class="carousel-item">
      <img src="misc/102.jpg" alt="New York">
    </div>
...
<div class="row">
	<div class="col-lg-6 col-md-6 col-12">
		<img src="misc/student.jpg"  height = "400" width="700">
	</div>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-4 col -md 4 col - 12">
				<div class="card" >
					<img class="card-img-top" src="misc/c++.jpg" alt="Card image">
						<div class="card-body">
			...
			<div class="col-lg-4 col -md 4 col - 12">
				<div class="card" >
					<img class="card-img-top" src="misc/505.jpg" alt="Card image">
						<div class="card-body">
			...
			<div class="col-lg-4 col -md 4 col - 12">
				<div class="card" >
					<img class="card-img-top" src="misc/507.jpg" alt="Card image">
						<div class="card-body">
...
<h2 class="text-center"> Our Gallery</h2>  
	...
	<div class ="container-fluid">
		...
		<div class="col-lg-4 col-md-4 col-12">
			...
			<source src="music/009.mp4" type="video/mp4">
					
		</div>
			<div class="col-lg-4 col-md-4 col-12">

			<video width="500" height="280" controls>
			<source src="music/3.mp4" type="video/mp4">
			
								
			
			</div>
			<div class="col-lg-4 col-md-4 col-12">
			<img src="misc/12.jpg" class="img-fluid pb-4">
